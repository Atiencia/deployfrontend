...
import { useEventosTranscurridos } from "../queries/eventosQueries";

export default function EventosTranscurridosPage() {
  const {data: eventos, isPending: loading, error} = useEventosTranscurridos()
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 md:ml-56 p-4 md:p-6 pt-20 md:pt-6 w-full">
        <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Eventos Transcurridos</h2>
        ...
        {loading && (
          <div className="flex justify-center items-center py-12">
            <LoadingSpinner size="lg" message="Cargando eventos transcurridos..." />
          </div>
        )}
